...
export class LangChain {
    ...
    async getStructuredContent(input: PromptPayload) {
        const prompt = ChatPromptTemplate.fromMessages([
            ...
            [
                'user',
                'The content created needs to be in the HTML format whenever possible, avoid using markdown. In the case of an Object Definition it should always be in JSON format.',
            ],
        ]);
